...
CrystalParticle::CrystalParticle(CR::Math::PointF position, CrystalParticleStyle cpStyle, TileType rType)
{
	...
	{
		case BassTile:
			m_sprite->SetImage(CR::AssetList::Piece_Shatter_1); //3
			break;
		case BoneTile:
			m_sprite->SetImage(CR::AssetList::Piece_Shatter_2);//1
			break;
		case HandTile:
