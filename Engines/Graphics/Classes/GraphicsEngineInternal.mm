...
GraphicsEngineInternal::GraphicsEngineInternal() : m_ambientLight(1.0f,1.0f,1.0f) , m_fpsCounterCount(0), cur_font(NULL)
{
...
void GraphicsEngineInternal::BeginFrame()
{
    ...
    glLoadIdentity();
    glOrthof(-160.0f, 160.0f, -240.0f, 240.0f, 0.0f, 1001.0f);
